...
public class CustomerService1 {
	...
	{
		Customer _customer = repository.save(new Customer(customer.getName(), customer.getAge(), customer.isActive()));
		//not commited
		...
		throw new RuntimeException("Outer exception in throwing");
		}
